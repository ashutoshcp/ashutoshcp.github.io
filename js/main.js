$(document)
  .ready(function() {
    ...
    $(document)
      .on('click', '.accordion > dt > a', function(e) {
    ...
    if ($('#nav-menu-container')
      ...
      $('body')
        .append($mobile_nav);
      $('body')
        .prepend('<button type="button" id="mobile-nav-toggle"><i class="lnr lnr-menu"></i></button>');
      $('body')
      ...
      $(document)
        .on('click', '.menu-has-children i', function(e) {
          $(this)
            .next()
      ...
      $(document)
        .on('click', '#mobile-nav-toggle', function(e) {
          ...
          $('#mobile-nav-toggle i')
            .toggleClass('lnr-cross lnr-menu');
          $('#mobile-body-overly')
            .toggle();
        });
    ...
    } else if ($("#mobile-nav, #mobile-nav-toggle")
      .length) {
          ...
          if (target.length) {
            ...
            if ($('body')
              ...
              $('body')
                .removeClass('mobile-nav-active');
              $('#mobile-nav-toggle i')
                .toggleClass('lnr-times lnr-bars');
              $('#mobile-body-overly')
                .fadeOut();
            }
            return false;
